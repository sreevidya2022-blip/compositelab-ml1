...
- Buckling Load (kN): measures the maximum compressive load the composite can withstand before structural instability / bowing.
...
Key insight: Tensile R² is ~0.19 not because the model is wrong, but because all tensile values cluster in a tiny 0.055 GPa range (2.87% CV). The absolute error is only ~1.2% which is engineering-grade accuracy.

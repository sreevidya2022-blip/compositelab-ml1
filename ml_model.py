...
def load_data(theory_path, fea_path, exp_path):
    ...
    df_theory = df_theory_raw[
        ["Carbon Fiber", "Boron Nitride", "Aluminium Oxide",
         "Tensile", ycol, "Hardness", "Buckling"]
    ].copy()
    ...
    df_fea = df_fea_raw[
        ["Carbon Fiber", "Boron Nitride", "Aluminium Oxide", ftc]
    ].copy()
...
def train_models(theory_path, fea_path, exp_path):
    ...
    for prop in TARGETS:
        ...
        all_r2[prop] = {"GPR": r2_gpr, "GBM": r2_gbm}

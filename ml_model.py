...
def load_data(theory_path, fea_path, exp_path):
    ...
    df_theory = df_theory_raw[["Carbon Fiber", "Boron Nitride", "Aluminium Oxide",
                                "Tensile", ycol, "Hardness", "Dielectrical"]].copy()
    df_theory.columns = ["CF", "BN", "AO", "Tensile", "Youngs", "Hardness", "Dielectrical"]
    ...
    df_exp.columns = ["CF", "BN", "AO", "Tensile", "Youngs", "Hardness", "Dielectrical"]
